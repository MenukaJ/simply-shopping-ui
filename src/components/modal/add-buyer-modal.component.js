...
export class AddBuyerModalComponent extends Component {
    constructor(props) {
        super(props);
        this.state={
            snackbaropen: false,
    ...
    handleSubmit(event) {
        ...
        BuyerService.addBuyer(event.target.firstName.value,
            ...
            <div className="container">
                ...
                >
                    <Modal.Header closeButton style={{background: '#0275d8', color: 'white'}}>
                        <Modal.Title id="contained-modal-title-vcenter">Add Buyer Details</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div className="container">
...
export default AddBuyerModalComponent